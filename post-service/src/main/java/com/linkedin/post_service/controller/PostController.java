...
public class PostController {
    ...
    public ResponseEntity<Post> createPost(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(postService.createPost(authorId,content,file));
    }
    ...
    public ResponseEntity<Comment> addComment(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(postService.addComment(postId,authorId,content));

    }

    @PostMapping("/{postId}")
    public ResponseEntity<String> deletePost(
            @PathVariable String postId, @RequestParam String id){
